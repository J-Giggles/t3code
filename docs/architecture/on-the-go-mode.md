...
This document consolidates the product and architecture contract established in GBT-125/GBT-126. Hard-to-reverse decisions remain in [the ADR index](../adr/README.md), verification is defined in the [Test Contract](./on-the-go-test-contract.md), and implementation sequencing lives in the [topic handoff](./on-the-go-topic-handoff.md).
