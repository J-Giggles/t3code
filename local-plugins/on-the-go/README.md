...
- Keep the stable `OTG-UT-001`–`OTG-UT-023` acceptance IDs and focused headed workflow synchronized whenever voice vocabulary or provider event mappings change.
