...
import { OnTheGoSettingsPanelView } from "./OnTheGoSettingsPanel";

describe("On-the-Go settings", () => {
  it("OTG-UT-019/021: exposes independent models, privacy, wake, and Barge-In controls", () => {
    ...
    expect(markup).toContain('aria-label="Transcription model provider"');
    expect(markup).toContain('aria-label="Theo model provider"');
    expect(markup).toContain('aria-label="Speech model provider"');
