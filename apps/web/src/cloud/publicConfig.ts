...
export function resolveRelayTracingConfig() {
  ...
  return relayTracing.tracesUrl
    ? {
        ...
        ...(relayTracing.tracesDataset ? { tracesDataset: relayTracing.tracesDataset } : {}),
        ...(relayTracing.tracesToken ? { tracesToken: relayTracing.tracesToken } : {}),
      }
    : null;
}
