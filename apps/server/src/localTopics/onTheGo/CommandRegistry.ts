...
export const onTheGoFoundationCommandRegistry = {
  ...
  "follow.stop": "owner",
  "follow.resume": "owner",
  "follow.chat-archived": "system",
  "follow.chat-deleted": "system",
  "follow.checkpoint.record": "system",
  "follow.catch-up": "owner",
  "follow.quiet-tick": "system",
