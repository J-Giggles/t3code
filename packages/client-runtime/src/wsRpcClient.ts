...
export interface WsRpcClient {
  ...
  readonly terminal: {
    ...
    readonly kill: RpcUnaryMethod<typeof WS_METHODS.terminalKill>;
  ...
  readonly appAutomation: {
    readonly connect: RpcInputStreamMethod<typeof WS_METHODS.appAutomationConnect>;
    readonly respond: RpcUnaryMethod<typeof WS_METHODS.appAutomationRespond>;
  ...
  readonly projects: {
    ...
    readonly listAgentFiles: RpcUnaryMethod<typeof WS_METHODS.projectsListAgentFiles>;
    readonly readAgentFile: RpcUnaryMethod<typeof WS_METHODS.projectsReadAgentFile>;
    readonly writeAgentFile: RpcUnaryMethod<typeof WS_METHODS.projectsWriteAgentFile>;
    readonly deleteAgentFile: RpcUnaryMethod<typeof WS_METHODS.projectsDeleteAgentFile>;
    readonly scaffoldAgentHarness: RpcUnaryMethod<typeof WS_METHODS.projectsScaffoldAgentHarness>;
    readonly writeAgentSecret: RpcUnaryMethod<typeof WS_METHODS.projectsWriteAgentSecret>;
    readonly deleteAgentSecret: RpcUnaryMethod<typeof WS_METHODS.projectsDeleteAgentSecret>;
  };
  readonly filesystem: {
  ...
  readonly vcs: {
    ...
    readonly workspaceSnapshot: RpcUnaryMethod<typeof WS_METHODS.workspaceGitSnapshot>;
  };
  readonly git: {
  ...
  readonly server: {
    ...
    readonly resetProvider: RpcUnaryMethod<typeof WS_METHODS.serverResetProvider>;
    readonly writeProviderSkillConfig: RpcUnaryMethod<
      typeof WS_METHODS.serverWriteProviderSkillConfig
    >;
    ...
    readonly restartRuntime: RpcUnaryMethod<typeof WS_METHODS.serverRestartRuntime>;
    readonly getDevLaunchState: RpcUnaryMethod<typeof WS_METHODS.serverGetDevLaunchState>;
    readonly launchDevApp: RpcUnaryMethod<typeof WS_METHODS.serverLaunchDevApp>;
    readonly stopDevApp: RpcUnaryMethod<typeof WS_METHODS.serverStopDevApp>;
    readonly listActiveDevLaunches: RpcUnaryNoArgMethod<
      typeof WS_METHODS.serverListActiveDevLaunches
    >;
    readonly buildDevLaunchCollisionPrompt: RpcUnaryMethod<
      typeof WS_METHODS.serverBuildDevLaunchCollisionPrompt
    >;
    readonly registerPushNotifications: RpcUnaryMethod<
      typeof WS_METHODS.serverRegisterPushNotifications
    >;
  };
  readonly cloud: {
...
export function createWsRpcClient(
  ...
  return {
    ...
    terminal: {
      ...
      kill: (input) => transport.request((client) => client[WS_METHODS.terminalKill](input)),
    ...
    appAutomation: {
      connect: (input, listener, options) =>
        transport.subscribe(
          (client) => client[WS_METHODS.appAutomationConnect](input),
          listener,
          subscriptionOptions(options, WS_METHODS.appAutomationConnect),
        ),
      respond: (input) =>
        transport.request((client) => client[WS_METHODS.appAutomationRespond](input)),
      reportOwner: (input) =>
    ...
    projects: {
      ...
      listAgentFiles: (input) =>
        transport.request((client) => client[WS_METHODS.projectsListAgentFiles](input)),
      readAgentFile: (input) =>
        transport.request((client) => client[WS_METHODS.projectsReadAgentFile](input)),
      writeAgentFile: (input) =>
        transport.request((client) => client[WS_METHODS.projectsWriteAgentFile](input)),
      deleteAgentFile: (input) =>
        transport.request((client) => client[WS_METHODS.projectsDeleteAgentFile](input)),
      scaffoldAgentHarness: (input) =>
        transport.request((client) => client[WS_METHODS.projectsScaffoldAgentHarness](input)),
      writeAgentSecret: (input) =>
        transport.request((client) => client[WS_METHODS.projectsWriteAgentSecret](input)),
      deleteAgentSecret: (input) =>
        transport.request((client) => client[WS_METHODS.projectsDeleteAgentSecret](input)),
    },
    filesystem: {
    ...
    vcs: {
      ...
      workspaceSnapshot: (input) =>
        transport.request((client) => client[WS_METHODS.workspaceGitSnapshot](input)),
    },
    git: {
    ...
    server: {
      ...
      resetProvider: (input) =>
        transport.request((client) => client[WS_METHODS.serverResetProvider](input)),
      writeProviderSkillConfig: (input) =>
        transport.request((client) => client[WS_METHODS.serverWriteProviderSkillConfig](input)),
      ...
      restartRuntime: (input) =>
        transport.request((client) => client[WS_METHODS.serverRestartRuntime](input)),
      getDevLaunchState: (input) =>
        transport.request((client) => client[WS_METHODS.serverGetDevLaunchState](input)),
      launchDevApp: (input) =>
        transport.request((client) => client[WS_METHODS.serverLaunchDevApp](input)),
      stopDevApp: (input) =>
        transport.request((client) => client[WS_METHODS.serverStopDevApp](input)),
      listActiveDevLaunches: () =>
        transport.request((client) => client[WS_METHODS.serverListActiveDevLaunches]({})),
      buildDevLaunchCollisionPrompt: (input) =>
        transport.request((client) =>
          client[WS_METHODS.serverBuildDevLaunchCollisionPrompt](input),
        ),
      registerPushNotifications: (input) =>
        transport.request((client) => client[WS_METHODS.serverRegisterPushNotifications](input)),
    },
    cloud: {
